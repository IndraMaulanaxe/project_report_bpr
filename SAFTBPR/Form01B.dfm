inherited fr_Form01B: Tfr_Form01B
  Caption = 
    'Form 01B - Laporan Penerapan SAF berdampak signifikan yang menca' +
    'kup informasi kejadian fraud dan informasi pelaku fraud berdampa' +
    'k signifikan'
  ClientHeight = 440
  ClientWidth = 861
  OnShow = FormShow
  ...
  inherited PanelContent: TcxGroupBox
    ...
    object cxgGrid: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = dsMyQ01B
        ...
        object cxGridDBTableView1keterangan_jenis_fraud: TcxGridDBColumn
          Caption = 'Keterangan Jenis Fraud'
          DataBinding.FieldName = 'keterangan_jenis_fraud'
          HeaderAlignmentHorz = taCenter
          Width = 200
        end
  ...
  object dsMyQ01B: TMyDataSource
    DataSet = MyQ01B
    Left = 320
    Top = 208
  end
  object MyQ01B: TMyQuery
    ...
    object MyQ01Bkode_komponen: TStringField
      FieldName = 'kode_komponen'
      FixedChar = True
      Size = 10
    end
    object MyQ01Bkejadian_fraud_menurut_pelaku: TStringField
      FieldName = 'kejadian_fraud_menurut_pelaku'
      FixedChar = True
      Size = 2
    end
    object MyQ01Bid_kejadian_fraud: TStringField
      FieldName = 'id_kejadian_fraud'
      FixedChar = True
      Size = 13
    end
    object MyQ01Bjenis_fraud: TStringField
      FieldName = 'jenis_fraud'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bketerangan_jenis_fraud: TStringField
      FieldName = 'keterangan_jenis_fraud'
      Size = 500
    end
    object MyQ01Baktivitas_terkait_fraud: TStringField
      FieldName = 'aktivitas_terkait_fraud'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bdeskripsi_fraud: TStringField
      FieldName = 'deskripsi_fraud'
      Size = 4000
    end
    object MyQ01Blokasi_fraud: TStringField
      FieldName = 'lokasi_fraud'
      FixedChar = True
      Size = 2
    end
    object MyQ01Bketerangan_lokasi_fraud: TStringField
      FieldName = 'keterangan_lokasi_fraud'
      FixedChar = True
      Size = 4
    end
    object MyQ01Bdivisi_unit_kerja: TStringField
      FieldName = 'divisi_unit_kerja'
      Size = 250
    end
    object MyQ01Bwaktu_terjadi_awal: TDateField
      FieldName = 'waktu_terjadi_awal'
    end
    object MyQ01Bwaktu_terjadi_akhir: TDateField
      FieldName = 'waktu_terjadi_akhir'
    end
    object MyQ01Bfraud_diketahui: TDateField
      FieldName = 'fraud_diketahui'
    end
    object MyQ01Bpihak_dirugikan: TStringField
      FieldName = 'pihak_dirugikan'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bjumlah_kerugian_potensial: TFloatField
      FieldName = 'jumlah_kerugian_potensial'
    end
    object MyQ01Btindak_lanjut_ljk: TStringField
      FieldName = 'tindak_lanjut_ljk'
      Size = 4000
    end
    object MyQ01Bintern_ekstern: TStringField
      FieldName = 'intern_ekstern'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bnama_pelaku: TStringField
      FieldName = 'nama_pelaku'
      Size = 50
    end
    object MyQ01Bjenis_identitas: TStringField
      FieldName = 'jenis_identitas'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bnomor_identitas: TStringField
      FieldName = 'nomor_identitas'
      Size = 50
    end
    object MyQ01Bjenis_kelamin: TStringField
      FieldName = 'jenis_kelamin'
      FixedChar = True
      Size = 1
    end
    object MyQ01Balamat_identitas: TStringField
      FieldName = 'alamat_identitas'
      Size = 500
    end
    object MyQ01Balamat_domisili: TStringField
      FieldName = 'alamat_domisili'
      Size = 500
    end
    object MyQ01Btempat_lahir: TStringField
      FieldName = 'tempat_lahir'
      Size = 150
    end
    object MyQ01Btanggal_lahir: TDateField
      FieldName = 'tanggal_lahir'
    end
    object MyQ01Bstatus_pelaku: TStringField
      FieldName = 'status_pelaku'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bjabatan_saat_fraud: TStringField
      FieldName = 'jabatan_saat_fraud'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bket_jabatan_saat_fraud: TStringField
      FieldName = 'ket_jabatan_saat_fraud'
      Size = 100
    end
    object MyQ01Bjabatan_saat_diketahui: TStringField
      FieldName = 'jabatan_saat_diketahui'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bket_jabatan_saat_diketahui: TStringField
      FieldName = 'ket_jabatan_saat_diketahui'
      Size = 100
    end
    object MyQ01Bketerangan_pelaku: TStringField
      FieldName = 'keterangan_pelaku'
      FixedChar = True
      Size = 3
    end
    object MyQ01Bpengenaan_sanksi: TStringField
      FieldName = 'pengenaan_sanksi'
      Size = 200
    end
    object MyQ01Bstatus_penanganan: TStringField
