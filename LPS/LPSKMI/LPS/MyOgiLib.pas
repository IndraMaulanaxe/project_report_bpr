...
//function GetComputerNetName: string; external 'OgiesoftLIB.dll';
//function GetUserFromWindows: string; external 'OgiesoftLIB.dll';
...
////function FindWindowByTitle(WindowTitle: string): Hwnd; external 'OgiesoftLIB.dll';
...
uses DateUtils, OgiesoftVAR, Math, StrUtils, CekPassword, dm_bpr, MyAccess, 
...
begin
  ...
  try
    ...
    on E: Exception do     //    on E: EIdException do
      begin
        dm_bpr1.MyCommand1.SQL.Text := 'INSERT INTO '+cDb2+'.`ogie_logbin` '+
...
//  dm_bpr1.MyCommand1.SQL.Text := cSQL;
//  try
//    dm_bpr1.MyCommand1.Execute;
//  except
//    MyExecuteSQL('INSERT INTO '+cDb2+'.`ogie_logbin` '+
//      'SET waktu=CONCAT('+cDb2+'.get_tgl()," ",'+
//        cDb2+'.get_jam()), source_bin='+QuotedStr(cSQL)+
//        ', AppVer='+QuotedStr(AmbilVersi));
//  end;
//
//  if dm_bpr1.MyCommand1.RowsAffected > 0 then
//    begin
//      Result := True;
//    end
//  else
...
//  except
//    MyExecuteSQL('INSERT INTO '+cDb2+'.`ogie_logbin` '+
//      'SET waktu=CONCAT('+dm_bpr1.MyCon2.Database+'.get_tgl()," ",'+
//        dm_bpr1.MyCon2.Database+'.get_jam()), source_bin='+QuotedStr(cSQL)+
//        ', AppVer='+QuotedStr(AmbilVersi));
//  end;
//
//  if dm_bpr1.MyCommand1.RowsAffected > 0 then
