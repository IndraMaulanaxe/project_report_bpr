...
type
  Tfr_MasterRefLPS = class(Tfr_template)
    sPanel1: TsPanel;
    sPanel2: TsPanel;
    Label58: TLabel;
    Edit1: TEdit;
...
var
  fr_MasterRefLPS: Tfr_MasterRefLPS;
...
procedure Tfr_MasterRefLPS.bt_closeClick(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure Tfr_MasterRefLPS.bt_pilihClick(Sender: TObject);
var
  cTemp: string;
begin
  inherited;
...
procedure Tfr_MasterRefLPS.bt_searchClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_MasterRefLPS.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure Tfr_MasterRefLPS.DBGrid1KeyDown(Sender: TObject;
...
procedure Tfr_MasterRefLPS.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure Tfr_MasterRefLPS.Edit1Change(Sender: TObject);
begin
  inherited;
  bt_searchClick(Sender);
end;

procedure Tfr_MasterRefLPS.FormActivate(Sender: TObject);
begin
  inherited;
  if MyQMasterReferensi.Active then
    MyQMasterReferensi.Refresh
...
procedure Tfr_MasterRefLPS.FormCreate(Sender: TObject);
begin
  inherited;
