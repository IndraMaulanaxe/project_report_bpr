...
var
  ...
  Ogie_FileIni, cNamaRaveReport, cOtorisatorParameter, cDb1, cDb2, cDb6,
  cParamWhere, cKolekBI, cTempSQL, cPerpanjangan, cSandiCabang: String;
  lGridColor,lHabis,lRegistered,lBackDate,lSaldoAwalNeraca: Boolean;
  dTglExpiredPassword, dTglSystem, dTgllSaldoAwalNeraca: TDate;
  cScriptSQL: TStrings;
  lLooping, lChange: Boolean;
  nRetry: Byte;
  ...
  nDueDays, ft_tunggakan_bi : Integer;
...
begin
  ...
  if not Empty(cPass) then
    begin
      ...
      ipcEzCrypt1.KeyPassword := 'bprkmi';
      ipcEzCrypt1.Encrypt();
