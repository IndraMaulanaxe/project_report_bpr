...
procedure Tfr_FormRefLPS.bt_closeClick(Sender: TObject);
begin
  Close;
end;

procedure Tfr_FormRefLPS.bt_pilihClick(Sender: TObject);
var
  cTemp: string;
begin
  inherited;
...
procedure Tfr_FormRefLPS.bt_searchClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_FormRefLPS.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure Tfr_FormRefLPS.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure Tfr_FormRefLPS.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure Tfr_FormRefLPS.Edit1Change(Sender: TObject);
begin
  bt_searchClick(Sender);
end;

procedure Tfr_FormRefLPS.FormActivate(Sender: TObject);
begin
  inherited;
  if MyQMasterReferensi.Active then
    MyQMasterReferensi.Refresh
...
procedure Tfr_FormRefLPS.FormCreate(Sender: TObject);
begin
  inherited;
