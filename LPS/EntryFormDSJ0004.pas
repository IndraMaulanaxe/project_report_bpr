...
type
  Tfr_EntryFormDSJ0004 = class(Tfr_new_template)
    ...
    cxLabel3: TcxLabel;
    persentase_kepemilikan: TcxCurrencyEdit;
    MyQTemp: TMyQuery;
...
var
  fr_EntryFormDSJ0004: Tfr_EntryFormDSJ0004;
...
function Tfr_EntryFormDSJ0004.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormDSJ0004.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormDSJ0004.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormDSJ0004.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormDSJ0004.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormDSJ0004.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormDSJ0004.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormDSJ0004.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
