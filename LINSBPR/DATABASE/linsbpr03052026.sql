...
(35,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-03-25 16:02:52','IT','11.11.11.42','DH-IT INDRA',NULL),
(36,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:24:13','IT','192.168.1.8','DH-IT INDRA',NULL),
(37,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:31:42','IT','192.168.1.8','DH-IT INDRA',NULL),
(38,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:37:02','IT','192.168.1.8','DH-IT INDRA',NULL),
(39,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:42:35','IT','192.168.1.8','DH-IT INDRA',NULL),
(40,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:44:11','IT','192.168.1.8','DH-IT INDRA',NULL),
(41,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 21:49:29','IT','192.168.1.8','DH-IT INDRA',NULL),
(42,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:17:56','IT','192.168.1.8','DH-IT INDRA',NULL),
(43,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:20:31','IT','192.168.1.8','DH-IT INDRA',NULL),
(44,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:31:13','IT','192.168.1.8','DH-IT INDRA',NULL),
(45,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:37:22','IT','192.168.1.8','DH-IT INDRA',NULL),
(46,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:39:27','IT','192.168.1.8','DH-IT INDRA',NULL),
(47,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:44:15','IT','192.168.1.8','DH-IT INDRA',NULL),
(48,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:44:54','IT','192.168.1.8','DH-IT INDRA',NULL),
(49,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:48:50','IT','192.168.1.8','DH-IT INDRA',NULL),
(50,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:50:45','IT','192.168.1.8','DH-IT INDRA',NULL),
(51,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 22:53:27','IT','192.168.1.8','DH-IT INDRA',NULL),
(52,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-04-28 23:10:05','IT','192.168.1.8','DH-IT INDRA',NULL),
(53,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-02 23:20:52','IT','192.168.1.3','DH-IT INDRA',NULL),
(54,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-02 23:39:17','IT','192.168.1.3','DH-IT INDRA',NULL),
(55,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:15:37','IT','192.168.1.5','DH-IT INDRA',NULL),
(56,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:23:51','IT','192.168.1.5','DH-IT INDRA',NULL),
(57,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:25:59','IT','192.168.1.5','DH-IT INDRA',NULL),
(58,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:28:02','IT','192.168.1.5','DH-IT INDRA',NULL),
(59,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:31:14','IT','192.168.1.5','DH-IT INDRA',NULL),
(60,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:35:44','IT','192.168.1.5','DH-IT INDRA',NULL),
(61,'LOGIN_LINSBPR_INDRA_MAULANA','Y','855','2026-05-03 11:37:01','IT','192.168.1.5','DH-IT INDRA',NULL);
...
/*Table structure for table `linsbpr_0100_092024` */

DROP TABLE IF EXISTS `linsbpr_0100_092024`;

CREATE TABLE `linsbpr_0100_092024` (
  `flag_detail` char(3) NOT NULL DEFAULT 'D01',
  `sandi_laporan` char(10) NOT NULL,
  `tanggal_kejadian` date NOT NULL,
  `nomor_sk_ojk` varchar(50) NOT NULL,
...
/*Data for the table `linsbpr_0100_092024` */
...
insert  into `linsbpr_0100_arsip`(`flag_detail`,`sandi_laporan`,`tanggal_kejadian`,`nomor_sk_ojk`,`tanggal_sk_ojk`,`nomor_akta`,`tanggal_akta`,`nomor_persetujuan`,`tanggal_persetujuan`,`tanggal_efektif`,`nama_pihak`,`nik_npwp`,`jabatan`,`jenis_produk`,`nama_produk`,`jenis_kantor`,`alamat`,`alamat_baru`,`tanggal_selesai`,`pelanggaran`,`alasan`,`nama_pjti`,`register_ref`,`langkah_perbaikan`,`target_waktu`,`realisasi`,`status`,`status_dokumen`,`kode_arsip`,`lampiran_file`) values 
('D01','KL001','2024-09-24','SK-1/2024 Koreksi','2024-08-22','NomorAkta1Koreksi','2024-09-21','NomorSetuju1Koreksi','2024-09-18','2024-09-23','','','','','','','','','1899-12-30','','Alasan 1 Koreksi','','','','1899-12-30','','','1','20240924KL001.pdf','1_24092024'),
('D01','KL001','2026-04-28','SK-1/2024 Koreksi','2024-08-22','NomorAkta1Koreksi','2024-09-21','NomorSetuju1Koreksi','2024-09-18','2024-09-23','','','','','','','','','1900-01-01','','Alasan 1 Koreksi','','','','1900-01-01','','','1','20260428KL001.pdf','1_28042026'),
('D01','KL002','2024-09-24','SK-2/2024 Koreksi','2024-08-23','NomorAkta2Koreksi','2024-09-22','NomorSetuju2Koreksi','2024-09-19','2024-09-24','','','','','','','','','1899-12-30','','Alasan 2 Koreksi','','','','1899-12-30','','','2','20240924KL002.pdf','1_24092024'),
('D01','KL002','2026-04-28','SK-2/2024 Koreksi','2024-08-23','NomorAkta2Koreksi','2024-09-22','NomorSetuju2Koreksi','2024-09-19','2024-09-24','','','','','','','','','1900-01-01','','Alasan 2 Koreksi','','','','1900-01-01','','','2','20260428KL002.pdf','1_28042026');
...
('1_24092024','2024-09-24',855,'2026-04-28 23:10:44','2026-04-28 23:10:44'),
('1_28042026','2026-04-28',855,'2026-05-03 11:36:37','2026-05-03 11:36:37');
...
('H01','010201','609999','2024-09-24','LINS','0100','0',''),
('H01','010201','609999','2024-09-24','LINS','0100','1',''),
('H01','010201','609999','2024-09-26','LINS','0100','0',''),
('H01','010201','609999','2026-03-20','LINS','0100','0',''),
('H01','010201','609999','2026-04-28','LINS','0100','0','');
...
('H01','010201','609999','2024-09-24','LINS','0100','0','','1_24092024'),
('H01','010201','609999','2024-09-26','LINS','0100','0','','1_092024'),
('H01','010201','609999','2024-09-26','LINS','0100','0','','1_26092024'),
('H01','010201','609999','2026-04-28','LINS','0100','0','','1_28042026');
...
CREATE TABLE `user_log` (
  ...
  KEY `kd_menu` (`kd_menu`),
  KEY `waktu` (`waktu`)
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='log user yang mengakses program';
...
(68,'indra_maulana','fr_GetSystemDate','2026-03-25 16:02:56','Login Tgl System Sukses : indra_maulana Tgl System : 25 Maret 2026 IP : 11.11.11.42 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(69,'indra_maulana','fr_LoginBPR','2026-03-25 16:02:57','Login Sukses : indra_maulana Tanggal System : 25 Maret 2026 IP : 11.11.11.42 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(70,'indra_maulana','fr_GetSystemDate','2026-04-28 21:24:15','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(71,'indra_maulana','fr_LoginBPR','2026-04-28 21:24:16','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(72,'indra_maulana','fr_GetSystemDate','2026-04-28 21:31:44','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(73,'indra_maulana','fr_LoginBPR','2026-04-28 21:31:45','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(74,'indra_maulana','fr_GetSystemDate','2026-04-28 21:37:04','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(75,'indra_maulana','fr_LoginBPR','2026-04-28 21:37:05','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(76,'indra_maulana','fr_GetSystemDate','2026-04-28 21:42:37','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(77,'indra_maulana','fr_LoginBPR','2026-04-28 21:42:38','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(78,'indra_maulana','fr_GetSystemDate','2026-04-28 21:44:13','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(79,'indra_maulana','fr_LoginBPR','2026-04-28 21:44:14','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(80,'indra_maulana','fr_GetSystemDate','2026-04-28 21:49:31','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(81,'indra_maulana','fr_LoginBPR','2026-04-28 21:49:32','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(82,'indra_maulana','fr_GetSystemDate','2026-04-28 22:17:58','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(83,'indra_maulana','fr_LoginBPR','2026-04-28 22:17:58','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(84,'indra_maulana','fr_GetSystemDate','2026-04-28 22:20:33','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(85,'indra_maulana','fr_LoginBPR','2026-04-28 22:20:33','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(86,'indra_maulana','fr_GetSystemDate','2026-04-28 22:31:15','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(87,'indra_maulana','fr_LoginBPR','2026-04-28 22:31:16','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(88,'indra_maulana','fr_GetSystemDate','2026-04-28 22:37:24','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(89,'indra_maulana','fr_LoginBPR','2026-04-28 22:37:25','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(90,'indra_maulana','fr_GetSystemDate','2026-04-28 22:39:29','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(91,'indra_maulana','fr_LoginBPR','2026-04-28 22:39:29','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(92,'indra_maulana','fr_GetSystemDate','2026-04-28 22:44:17','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(93,'indra_maulana','fr_LoginBPR','2026-04-28 22:44:18','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(94,'indra_maulana','fr_GetSystemDate','2026-04-28 22:44:56','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(95,'indra_maulana','fr_LoginBPR','2026-04-28 22:44:57','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(96,'indra_maulana','fr_GetSystemDate','2026-04-28 22:48:53','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(97,'indra_maulana','fr_LoginBPR','2026-04-28 22:48:53','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(98,'indra_maulana','fr_GetSystemDate','2026-04-28 22:50:47','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(99,'indra_maulana','fr_LoginBPR','2026-04-28 22:50:48','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(100,'indra_maulana','fr_GetSystemDate','2026-04-28 22:53:29','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(101,'indra_maulana','fr_LoginBPR','2026-04-28 22:53:30','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(102,'indra_maulana','fr_GetSystemDate','2026-04-28 23:10:08','Login Tgl System Sukses : indra_maulana Tgl System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(103,'indra_maulana','fr_LoginBPR','2026-04-28 23:10:08','Login Sukses : indra_maulana Tanggal System : 28 April 2026 IP : 192.168.1.8 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(104,'indra_maulana','fr_GetSystemDate','2026-05-02 23:20:55','Login Tgl System Sukses : indra_maulana Tgl System : 02 Mei 2026 IP : 192.168.1.3 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(105,'indra_maulana','fr_LoginBPR','2026-05-02 23:20:55','Login Sukses : indra_maulana Tanggal System : 02 Mei 2026 IP : 192.168.1.3 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(106,'indra_maulana','fr_GetSystemDate','2026-05-02 23:39:18','Login Tgl System Sukses : indra_maulana Tgl System : 02 Mei 2026 IP : 192.168.1.3 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(107,'indra_maulana','fr_LoginBPR','2026-05-02 23:39:19','Login Sukses : indra_maulana Tanggal System : 02 Mei 2026 IP : 192.168.1.3 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(108,'indra_maulana','fr_GetSystemDate','2026-05-03 11:15:41','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(109,'indra_maulana','fr_LoginBPR','2026-05-03 11:15:42','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(110,'indra_maulana','fr_GetSystemDate','2026-05-03 11:23:54','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(111,'indra_maulana','fr_LoginBPR','2026-05-03 11:23:55','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(112,'indra_maulana','fr_GetSystemDate','2026-05-03 11:26:02','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(113,'indra_maulana','fr_LoginBPR','2026-05-03 11:26:03','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(114,'indra_maulana','fr_GetSystemDate','2026-05-03 11:28:05','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(115,'indra_maulana','fr_LoginBPR','2026-05-03 11:28:06','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(116,'indra_maulana','fr_GetSystemDate','2026-05-03 11:31:18','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(117,'indra_maulana','fr_LoginBPR','2026-05-03 11:31:19','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(118,'indra_maulana','fr_GetSystemDate','2026-05-03 11:35:48','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(119,'indra_maulana','fr_LoginBPR','2026-05-03 11:35:48','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(120,'indra_maulana','fr_GetSystemDate','2026-05-03 11:37:05','Login Tgl System Sukses : indra_maulana Tgl System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0'),
(121,'indra_maulana','fr_LoginBPR','2026-05-03 11:37:06','Login Sukses : indra_maulana Tanggal System : 04 Mei 2026 IP : 192.168.1.5 OS User : DH-IT INDRA',NULL,'1.0.0.0');
