...
var
  fr_FormRefLINS: Tfr_FormRefLINS;
...
procedure Tfr_FormRefLINS.bt_closeClick(Sender: TObject);
begin
  Close;
end;

procedure Tfr_FormRefLINS.bt_pilihClick(Sender: TObject);
var
  cTemp: string;
begin
  inherited;
...
procedure Tfr_FormRefLINS.bt_searchClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_FormRefLINS.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure Tfr_FormRefLINS.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure Tfr_FormRefLINS.DBGrid1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure Tfr_FormRefLINS.Edit1Change(Sender: TObject);
begin
  bt_searchClick(Sender);
end;

procedure Tfr_FormRefLINS.FormActivate(Sender: TObject);
begin
  inherited;
  if MyQMasterReferensi.Active then
    MyQMasterReferensi.Refresh
...
procedure Tfr_FormRefLINS.FormCreate(Sender: TObject);
begin
  inherited;
