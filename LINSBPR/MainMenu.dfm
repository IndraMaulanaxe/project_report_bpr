object fr_MainMenu: Tfr_MainMenu
  ...
  object cxGroupBox1: TcxGroupBox
    ...
    object ProductName: TcxLabel
      ...
      Align = alClient
      Caption = 
        'Laporan Insidental - Aplikasi Pelaporan Online OJK, Modul Lapora' +
        'n Bank Perekonomian Rakyat (BPR), '#13#10'File Export berupa Text File' +
        ' sesuai Format yang ditentukan OJK yang terdiri dari 2 File'
      ParentFont = False
