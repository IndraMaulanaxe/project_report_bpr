...
type
  Tfr_EntryFormE0100 = class(Tfr_new_template)
    MyDataSource1: TMyDataSource;
    cxLabel8: TcxLabel;
    mempenjelasan_peringkat: TcxMemo;
    cxLabel10: TcxLabel;
    kode_komponen: TcxButtonEdit;
    Label3: TcxLabel;
    Label1: TcxLabel;
    memalamat: TcxMemo;
    cb_peringkat: TcxLookupComboBox;
    cxLabel2: TcxLabel;
    dsMyQRefPeringkat: TMyDataSource;
    MyQRefPeringkat: TMyQuery;
    MyQRefPeringkatsandi: TStringField;
    MyQRefPeringkatnama: TStringField;
    mempenjelasan: TcxMemo;
    Label6: TcxLabel;
    nomor_telp: TcxTextEdit;
...
var
  fr_EntryFormE0100: Tfr_EntryFormE0100;
...
function Tfr_EntryFormE0100.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0100.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0100.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0100.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0100.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0100.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0100.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0100.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
