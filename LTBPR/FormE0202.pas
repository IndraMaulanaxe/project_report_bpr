...
type
  Tfr_FormE0202 = class(Tfr_new_template)
    ...
    MyQE0202footer_1_tindak_lanjut: TStringField;
    MyQE0202footer_2_penjelasan_lebih_lanjut: TStringField;
...
begin
  ...
  with fr_EntryFormE0202 do
    begin
      ...
      memtindak_lanjut.Properties.MaxLength := MyQE0202footer_1_tindak_lanjut.Size;
      memlebih_lanjut.Properties.MaxLength := MyQE0202footer_2_penjelasan_lebih_lanjut.Size;
      ...
      memtindak_lanjut.Text := MyQE0202footer_1_tindak_lanjut.Text;
      memlebih_lanjut.Text := MyQE0202footer_2_penjelasan_lebih_lanjut.Text;
