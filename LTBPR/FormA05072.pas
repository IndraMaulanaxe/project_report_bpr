...
type
  Tfr_FormA05072 = class(Tfr_new_template)
    ...
    dsMyQA05072: TMyDataSource;
    MyQA05072: TMyQuery;
    cxgGrid: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    MyQA05072flag_detail: TStringField;
    MyQA05072kode_komponen: TStringField;
    MyQA05072kegiatan_pengembangan: TStringField;
    MyQA05072tanggal_pelaksanaan: TDateField;
    MyQA05072pihak_pelaksana: TStringField;
    MyQA05072kategori_peserta: TStringField;
    MyQA05072jumlah_peserta: TIntegerField;
    MyQA05072uraian_kegiatan: TStringField;
    MyQA05072keterangan: TStringField;
    cxGridDBTableView1flag_detail: TcxGridDBColumn;
    cxGridDBTableView1kode_komponen: TcxGridDBColumn;
    cxGridDBTableView1kegiatan_pengembangan: TcxGridDBColumn;
    cxGridDBTableView1tanggal_pelaksanaan: TcxGridDBColumn;
    cxGridDBTableView1pihak_pelaksana: TcxGridDBColumn;
...
procedure Tfr_FormA05072.judulMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  cNewCaption: String;
  jml2: Integer;
...
procedure Tfr_FormA05072.GetOgieGlobalSetting;
begin
...
procedure Tfr_FormA05072.btlb_DeleteClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_FormA05072.btlb_EditClick(Sender: TObject);
begin
  inherited;
  if (MyQA05072.RecordCount=0) or (not MyQA05072.Active) then
    begin
  ...
  if Application.FindComponent('fr_EntryFormA05072') = nil then
    Application.CreateForm(Tfr_EntryFormA05072, fr_EntryFormA05072);

  with fr_EntryFormA05072 do
    begin
      ...
      memketerangan.Properties.MaxLength := MyQA05072keterangan.Size;
      ...
      memketerangan.Text := MyQA05072keterangan.Text;

      kode_komponen.Enabled := False;
    end;
  fr_EntryFormA05072.Tag := 0;
  fr_EntryFormA05072.ShowModal;
  if fr_EntryFormA05072.Tag=2 then
    begin
      with fr_EntryFormA05072 do
        begin
          // Update
...
procedure Tfr_FormA05072.btlb_RefreshClick(Sender: TObject);
begin
  inherited;
  if MyQA05072.Active then
    MyQA05072.Refresh
...
procedure Tfr_FormA05072.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action := caFree;
end;

procedure Tfr_FormA05072.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  if (Tag=1) then
    begin
...
procedure Tfr_FormA05072.AssignJudulEvent;
var
  i: Integer;
  PropInfo: PPropInfo;
  Method: TMethod;
...
procedure Tfr_FormA05072.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_FormA05072.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure Tfr_FormA05072.FormShow(Sender: TObject);
begin
  inherited;
