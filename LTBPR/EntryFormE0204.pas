...
type
  Tfr_EntryFormE0204 = class(Tfr_new_template)
    ...
    cxLabel1: TcxLabel;
    cxLabel3: TcxLabel;
    cb_audit: TcxLookupComboBox;
    dsMyQRefKomite: TMyDataSource;
    MyQRefKomite: TMyQuery;
    MyQRefKomitesandi: TStringField;
    MyQRefKomitenama: TStringField;
    cb_pantau: TcxLookupComboBox;
    cxLabel4: TcxLabel;
    cb_manaj: TcxLookupComboBox;
    cxLabel5: TcxLabel;
    cb_remunerasi: TcxLookupComboBox;
    cxLabel6: TcxLabel;
    cxLabel7: TcxLabel;
    cxLabel9: TcxLabel;
    Label6: TcxLabel;
    nama_anggota: TcxTextEdit;
    cxLabel2: TcxLabel;
    MyQRefindepeden: TMyQuery;
    StringField1: TStringField;
    StringField2: TStringField;
    dsMyQRefindepeden: TMyDataSource;
    nik: TcxTextEdit;
    cb_lainya: TcxLookupComboBox;
    cb_pihak: TcxLookupComboBox;
...
var
  fr_EntryFormE0204: Tfr_EntryFormE0204;
...
function Tfr_EntryFormE0204.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0204.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0204.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0204.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0204.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0204.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0204.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0204.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
