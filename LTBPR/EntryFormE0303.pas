...
type
  Tfr_EntryFormE0303 = class(Tfr_new_template)
    ...
    nama: TcxTextEdit;
    cxLabel4: TcxLabel;
    cb_sandibank: TcxLookupComboBox;
    cxLabel1: TcxLabel;
    nama_bank: TcxTextEdit;
    dsMyQRefSandiBank: TMyDataSource;
    MyQRefSandiBank: TMyQuery;
    MyQRefSandiBanksandi: TStringField;
    MyQRefSandiBanknama: TStringField;
...
var
  fr_EntryFormE0303: Tfr_EntryFormE0303;
...
function Tfr_EntryFormE0303.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0303.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0303.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0303.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0303.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0303.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0303.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0303.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
