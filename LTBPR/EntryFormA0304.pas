...
type
  Tfr_EntryFormA0304 = class(Tfr_new_template)
...
var
  fr_EntryFormA0304: Tfr_EntryFormA0304;
...
function Tfr_EntryFormA0304.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormA0304.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormA0304.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormA0304.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormA0304.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormA0304.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormA0304.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormA0304.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
