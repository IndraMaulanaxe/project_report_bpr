...
type
  Tfr_EntryFormE0600 = class(Tfr_new_template)
    ...
    MyQRefRasionama: TStringField;
    cxLabel9: TcxLabel;
    cxLabel8: TcxLabel;
    cb_komponen: TcxLookupComboBox;
    rasio: TcxCurrencyEdit;
...
var
  fr_EntryFormE0600: Tfr_EntryFormE0600;
...
function Tfr_EntryFormE0600.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0600.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0600.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0600.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0600.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0600.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0600.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0600.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
