...
type
  Tfr_EntryFormA0506 = class(Tfr_new_template)
    MyDataSource1: TMyDataSource;
    cxLabel8: TcxLabel;
    memjenis_kerjasama: TcxMemo;
    memuraian_kerjasama: TcxMemo;
    cxLabel10: TcxLabel;
    kode_komponen: TcxButtonEdit;
    Label3: TcxLabel;
    cxLabel1: TcxLabel;
    memnama_bank_lembaga: TcxMemo;
    cxLabel9: TcxLabel;
    cb_ref_lembaga: TcxLookupComboBox;
    cxLabel2: TcxLabel;
    cb_sandi_bank: TcxLookupComboBox;
    dsMyQRefLembaga: TMyDataSource;
    MyQRefLembaga: TMyQuery;
    MyQRefLembagasandi: TStringField;
    MyQRefLembaganama: TStringField;
    npwp: TcxTextEdit;
    cxLabel3: TcxLabel;
    Label6: TcxLabel;
...
var
  fr_EntryFormA0506: Tfr_EntryFormA0506;
...
procedure Tfr_EntryFormA0506.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormA0506.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormA0506.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormA0506.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormA0506.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormA0506.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormA0506.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
