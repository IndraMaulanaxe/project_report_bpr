inherited fr_FormE0702: Tfr_FormE0702
  Caption = 'Form E0702 - Kehadiran Anggota Dewan Komisaris'
  ClientHeight = 440
  ClientWidth = 861
  OnShow = FormShow
  ExplicitWidth = 867
  ...
  inherited PanelContent: TcxGroupBox
    ...
    object cxgGrid: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = dsMyQE0702
        ...
        object cxGridDBTableView1nama_anggota_dewan_komisaris: TcxGridDBColumn
          Caption = 'Nama Komisaris'
          DataBinding.FieldName = 'nama_anggota_dewan_komisaris'
          HeaderAlignmentHorz = taCenter
          Width = 250
        end
        object cxGridDBTableView1frekuensi_kehadiran_fisik: TcxGridDBColumn
          Caption = 'Frekuensi Kehadiran (Fisik)'
          DataBinding.FieldName = 'frekuensi_kehadiran_fisik'
          HeaderAlignmentHorz = taCenter
          Width = 200
        end
        object cxGridDBTableView1frekuensi_kehadiran: TcxGridDBColumn
          Caption = 'Frekuensi Kehadiran'
          DataBinding.FieldName = 'frekuensi_kehadiran'
          HeaderAlignmentHorz = taCenter
          Width = 200
        end
        object cxGridDBTableView1tingkat_kehadiran: TcxGridDBColumn
          Caption = 'Tinggat Kehadiran (%)'
          DataBinding.FieldName = 'tingkat_kehadiran'
          HeaderAlignmentHorz = taCenter
          Width = 200
        end
  ...
  object dsMyQE0702: TMyDataSource
    DataSet = MyQE0702
    Left = 312
    Top = 224
  end
  object MyQE0702: TMyQuery
    Connection = dm_bpr1.MyCon2
    SQL.Strings = (
      'select * from ltbprk_e0702_kehadiran_anggota_komisaris')
    ReadOnly = True
    Options.FieldOrigins = foNone
    Left = 312
    Top = 280
    object MyQE0702flag_detail: TStringField
      FieldName = 'flag_detail'
      Size = 3
    end
    object MyQE0702kode_komponen: TStringField
      FieldName = 'kode_komponen'
      Size = 12
    end
    object MyQE0702nik: TStringField
      FieldName = 'nik'
      Size = 25
    end
    object MyQE0702nama_anggota_dewan_komisaris: TStringField
      FieldName = 'nama_anggota_dewan_komisaris'
      Size = 50
    end
    object MyQE0702frekuensi_kehadiran_fisik: TIntegerField
      FieldName = 'frekuensi_kehadiran_fisik'
    end
    object MyQE0702frekuensi_kehadiran: TIntegerField
      FieldName = 'frekuensi_kehadiran'
    end
    object MyQE0702tingkat_kehadiran: TFloatField
      FieldName = 'tingkat_kehadiran'
    end
    object MyQE0702footer_1_penjelasan_lebih_lanjut: TStringField
