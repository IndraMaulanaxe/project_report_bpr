...
type
  Tfr_FormE1000 = class(Tfr_new_template)
    ...
    dsMyQE1000: TMyDataSource;
    MyQE1000: TMyQuery;
    cxgGrid: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    MyQE1000flag_detail: TStringField;
    MyQE1000kode_komponen: TStringField;
    MyQE1000pihak_yang_memiliki_nama: TStringField;
    MyQE1000pihak_yang_memiliki_jabatan: TStringField;
    MyQE1000pihak_yang_memiliki_nik: TStringField;
    MyQE1000pengambil_keputusan_nama: TStringField;
    MyQE1000pengambil_keputusan_jabatan: TStringField;
    MyQE1000pengambil_keputusan_nik: TStringField;
    MyQE1000jenis_transaksi: TStringField;
    MyQE1000nilai_transaksi: TFloatField;
    MyQE1000keterangan: TStringField;
    MyQE1000footer_1_penjelasan_lebih_lanjut: TStringField;
    cxGridDBTableView1flag_detail: TcxGridDBColumn;
    cxGridDBTableView1kode_komponen: TcxGridDBColumn;
    cxGridDBTableView1pihak_yang_memiliki_nama: TcxGridDBColumn;
    cxGridDBTableView1pihak_yang_memiliki_jabatan: TcxGridDBColumn;
    cxGridDBTableView1pihak_yang_memiliki_nik: TcxGridDBColumn;
    cxGridDBTableView1pengambil_keputusan_nama: TcxGridDBColumn;
    cxGridDBTableView1pengambil_keputusan_jabatan: TcxGridDBColumn;
    cxGridDBTableView1pengambil_keputusan_nik: TcxGridDBColumn;
    cxGridDBTableView1jenis_transaksi: TcxGridDBColumn;
...
procedure Tfr_FormE1000.judulMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  cNewCaption: String;
  jml2: Integer;
...
procedure Tfr_FormE1000.GetOgieGlobalSetting;
begin
...
procedure Tfr_FormE1000.btlb_DeleteClick(Sender: TObject);
begin
  inherited;
  if (MyQE1000.RecordCount=0) or (not MyQE1000.Active) then
    begin
...
procedure Tfr_FormE1000.btlb_EditClick(Sender: TObject);
begin
  inherited;
  if (MyQE1000.RecordCount=0) or (not MyQE1000.Active) then
    begin
  ...
  if Application.FindComponent('fr_EntryFormE1000') = nil then
    Application.CreateForm(Tfr_EntryFormE1000, fr_EntryFormE1000);
  ...
  with fr_EntryFormE1000 do
    begin
      ...
      //size
      kode_komponen.Properties.MaxLength := MyQE1000kode_komponen.Size;
      nama_milik.Properties.MaxLength := MyQE1000pihak_yang_memiliki_nama.Size;
      jabatan_milik.Properties.MaxLength := MyQE1000pihak_yang_memiliki_jabatan.Size;
      nik_milik.Properties.MaxLength := MyQE1000pihak_yang_memiliki_nik.Size;
      nama_putusan.Properties.MaxLength := MyQE1000pengambil_keputusan_nama.Size;
      jabatan_putusan.Properties.MaxLength := MyQE1000pengambil_keputusan_jabatan.Size;
      nik_putusan.Properties.MaxLength := MyQE1000pengambil_keputusan_nik.Size;
      jenis_trans.Properties.MaxLength := MyQE1000jenis_transaksi.Size;
      nilai_trans.Properties.MaxLength := MyQE1000nilai_transaksi.Size;
      memketer.Properties.MaxLength := MyQE1000keterangan.Size;
      mempenjelasan.Properties.MaxLength := MyQE1000footer_1_penjelasan_lebih_lanjut.Size;

      //assignment
      kode_komponen.Text := MyQE1000kode_komponen.Text;
      nama_milik.Text := MyQE1000pihak_yang_memiliki_nama.Text;
      jabatan_milik.Text := MyQE1000pihak_yang_memiliki_jabatan.Text;
      nik_milik.Text := MyQE1000pihak_yang_memiliki_nik.Text;
      nama_putusan.Text := MyQE1000pengambil_keputusan_nama.Text;
      jabatan_putusan.Text := MyQE1000pengambil_keputusan_jabatan.Text;
      nik_putusan.Text := MyQE1000pengambil_keputusan_nik.Text;
      ...
      mempenjelasan.Text := MyQE1000footer_1_penjelasan_lebih_lanjut.Text;

      kode_komponen.Enabled := False;
    end;
  fr_EntryFormE1000.Tag := 0;
  fr_EntryFormE1000.ShowModal;
  if fr_EntryFormE1000.Tag=2 then
    begin
      with fr_EntryFormE1000 do
        begin
          // Update
          MyExecuteSQL('UPDATE '+cDb2+'.`ltbprk_e1000_transaksi_benturan_kepentingan` '+
...
begin
  ...
  with fr_EntryFormE1000 do
    begin
      ...
      //assignment
      kode_komponen.Text := '110100000000';
...
procedure Tfr_FormE1000.btlb_RefreshClick(Sender: TObject);
begin
  inherited;
  if MyQE1000.Active then
    MyQE1000.Refresh
...
procedure Tfr_FormE1000.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action := caFree;
end;

procedure Tfr_FormE1000.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  if (Tag=1) then
    begin
...
procedure Tfr_FormE1000.AssignJudulEvent;
var
  i: Integer;
  PropInfo: PPropInfo;
  Method: TMethod;
...
procedure Tfr_FormE1000.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_FormE1000.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure Tfr_FormE1000.FormShow(Sender: TObject);
begin
  inherited;
