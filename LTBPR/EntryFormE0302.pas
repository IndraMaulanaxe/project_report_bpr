...
type
  Tfr_EntryFormE0302 = class(Tfr_new_template)
    ...
    cxLabel3: TcxLabel;
    cxLabel8: TcxLabel;
    persen_sebelumya: TcxCurrencyEdit;
    cxLabel1: TcxLabel;
...
var
  fr_EntryFormE0302: Tfr_EntryFormE0302;
...
function Tfr_EntryFormE0302.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0302.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0302.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0302.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0302.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0302.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0302.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0302.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
