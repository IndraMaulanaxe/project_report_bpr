...
type
  Tfr_EntryFormE0402 = class(Tfr_new_template)
...
var
  fr_EntryFormE0402: Tfr_EntryFormE0402;
...
function Tfr_EntryFormE0402.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0402.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0402.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0402.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0402.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0402.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0402.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0402.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
