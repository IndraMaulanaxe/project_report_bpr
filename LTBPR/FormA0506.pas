...
type
  Tfr_FormA0506 = class(Tfr_new_template)
    ...
    dsMyQA0506: TMyDataSource;
    MyQA0506: TMyQuery;
    cxgGrid: TcxGrid;
    cxGridDBTableView1: TcxGridDBTableView;
    cxGridLevel1: TcxGridLevel;
    MyQA0506flag_detail: TStringField;
    MyQA0506kode_komponen: TStringField;
    MyQA0506referensi_lembaga: TStringField;
    MyQA0506nama_bank_lembaga_lain: TStringField;
    MyQA0506sandi_bank: TStringField;
    MyQA0506npwp: TStringField;
    ...
    cxGridDBTableView1nama_bank_lembaga_lain: TcxGridDBColumn;
    cxGridDBTableView1sandi_bank: TcxGridDBColumn;
    cxGridDBTableView1npwp: TcxGridDBColumn;
...
procedure Tfr_FormA0506.GetOgieGlobalSetting;
begin
...
procedure Tfr_FormA0506.btlb_DeleteClick(Sender: TObject);
begin
  inherited;
...
begin
  ...
  if Application.FindComponent('fr_EntryFormA0506') = nil then
    Application.CreateForm(Tfr_EntryFormA0506, fr_EntryFormA0506);

  with fr_EntryFormA0506 do
    begin

      //open table reff
      if MyQRefLembaga.Active then
        MyQRefLembaga.Refresh
      else
        MyQRefLembaga.Open;
      ...
      //size
      kode_komponen.Properties.MaxLength := MyQA0506kode_komponen.Size;
      cb_ref_lembaga.Properties.MaxLength := MyQA0506referensi_lembaga.Size;
      memnama_bank_lembaga.Properties.MaxLength := MyQA0506nama_bank_lembaga_lain.Size;
      cb_sandi_bank.Properties.MaxLength := MyQA0506sandi_bank.Size;
      ...
      //assignment
      kode_komponen.Text := MyQA0506kode_komponen.Text;
      cb_ref_lembaga.EditValue := MyQA0506referensi_lembaga.Text;
      memnama_bank_lembaga.Text := MyQA0506nama_bank_lembaga_lain.Text;
      cb_sandi_bank.EditValue := MyQA0506sandi_bank.Text;
  ...
  fr_EntryFormA0506.Tag := 0;
  fr_EntryFormA0506.ShowModal;
  if fr_EntryFormA0506.Tag=2 then
    begin
      with fr_EntryFormA0506 do
        begin
          // Update
...
begin
  ...
  with fr_EntryFormA0506 do
    begin
      ...
      //assignment
      kode_komponen.Text := '05002';
      tgl_kerjasama.Date := dTglSystem;
...
procedure Tfr_FormA0506.btlb_RefreshClick(Sender: TObject);
begin
  inherited;
  if MyQA0506.Active then
    MyQA0506.Refresh
...
procedure Tfr_FormA0506.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Release;
  Action := caFree;
end;

procedure Tfr_FormA0506.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  if (Tag=1) then
    begin
...
procedure Tfr_FormA0506.AssignJudulEvent;
var
  i: Integer;
  PropInfo: PPropInfo;
  Method: TMethod;
...
procedure Tfr_FormA0506.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_FormA0506.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure Tfr_FormA0506.FormShow(Sender: TObject);
begin
  inherited;
