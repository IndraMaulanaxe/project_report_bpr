...
type
  Tfr_EntryFormE0900 = class(Tfr_new_template)
    ...
    cxLabel1: TcxLabel;
    jumlah_perdata: TcxCurrencyEdit;
    MyQRefHukum: TMyQuery;
    MyQRefHukumsandi: TStringField;
    MyQRefHukumnama: TStringField;
    dsMyQRefHukum: TMyDataSource;
...
var
  fr_EntryFormE0900: Tfr_EntryFormE0900;
...
function Tfr_EntryFormE0900.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0900.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0900.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0900.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0900.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0900.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0900.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0900.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
