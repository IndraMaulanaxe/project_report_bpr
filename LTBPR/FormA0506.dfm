inherited fr_FormA0506: Tfr_FormA0506
  Caption = 'Form A0506 - Kerja Sama BPR dengan Bank atau Lembaga Lain'
  ClientHeight = 440
  ClientWidth = 861
  OnShow = FormShow
  ExplicitWidth = 867
  ...
  inherited PanelContent: TcxGroupBox
    ...
    object cxgGrid: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = dsMyQA0506
        ...
        object cxGridDBTableView1referensi_lembaga: TcxGridDBColumn
          Caption = 'Referensi Lembaga'
          DataBinding.FieldName = 'referensi_lembaga'
          HeaderAlignmentHorz = taCenter
          Width = 117
        end
        object cxGridDBTableView1nama_bank_lembaga_lain: TcxGridDBColumn
          Caption = 'Nama Bank / Lembaga Lain'
          DataBinding.FieldName = 'nama_bank_lembaga_lain'
          HeaderAlignmentHorz = taCenter
          Width = 200
        end
        object cxGridDBTableView1sandi_bank: TcxGridDBColumn
          Caption = 'Sandi Bank'
          DataBinding.FieldName = 'sandi_bank'
          HeaderAlignmentHorz = taCenter
          Width = 100
        end
        object cxGridDBTableView1npwp: TcxGridDBColumn
          Caption = 'NPWP'
          DataBinding.FieldName = 'npwp'
          HeaderAlignmentHorz = taCenter
        end
        object cxGridDBTableView1jenis_kerja_sama: TcxGridDBColumn
          Caption = 'Jenis Kerja Sama'
          DataBinding.FieldName = 'jenis_kerja_sama'
          HeaderAlignmentHorz = taCenter
          Width = 300
        end
        object cxGridDBTableView1uraian_kerja_sama: TcxGridDBColumn
          Caption = 'Iuran Kerja Sama'
          DataBinding.FieldName = 'uraian_kerja_sama'
          HeaderAlignmentHorz = taCenter
          Width = 300
        end
        object cxGridDBTableView1tanggal_mulai_kerja_sama: TcxGridDBColumn
          Caption = 'Tanggal Kerja Sama'
          DataBinding.FieldName = 'tanggal_mulai_kerja_sama'
          HeaderAlignmentHorz = taCenter
          Width = 150
        end
      end
    ...
    object cxGBFooter: TcxGroupBox
      ...
      object memketerangan_footer: TcxMemo
        Tag = 1
        Left = 180
        Top = 17
        Hint = 'Keterangan'
  ...
  object dsMyQA0506: TMyDataSource
    DataSet = MyQA0506
    Left = 312
    Top = 224
  end
  object MyQA0506: TMyQuery
    Connection = dm_bpr1.MyCon2
    SQL.Strings = (
      'select * from ltbprk_a0506_kerja_sama_lembaga')
    ReadOnly = True
    Options.FieldOrigins = foNone
    Left = 312
    Top = 280
    object MyQA0506flag_detail: TStringField
      FieldName = 'flag_detail'
      Size = 3
    end
    object MyQA0506kode_komponen: TStringField
      FieldName = 'kode_komponen'
      Size = 5
    end
    object MyQA0506referensi_lembaga: TStringField
      FieldName = 'referensi_lembaga'
      Size = 1
    end
    object MyQA0506nama_bank_lembaga_lain: TStringField
      FieldName = 'nama_bank_lembaga_lain'
      Size = 2000
    end
    object MyQA0506sandi_bank: TStringField
      FieldName = 'sandi_bank'
      Size = 50
    end
    object MyQA0506npwp: TStringField
      FieldName = 'npwp'
      Size = 25
    end
    object MyQA0506jenis_kerja_sama: TStringField
      FieldName = 'jenis_kerja_sama'
      Size = 2000
    end
    object MyQA0506uraian_kerja_sama: TStringField
      FieldName = 'uraian_kerja_sama'
      Size = 2000
    end
