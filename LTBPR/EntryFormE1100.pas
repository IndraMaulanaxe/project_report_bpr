...
type
  Tfr_EntryFormE1100 = class(Tfr_new_template)
    ...
    cxLabel1: TcxLabel;
    cb_jenis_kegiatan: TcxLookupComboBox;
    cxLabel3: TcxLabel;
    mempenjelasan_kegiatan: TcxMemo;
    dsMyQRefJenis_Kegiatan: TMyDataSource;
    MyQRefJenis_Kegiatan: TMyQuery;
    MyQRefJenis_Kegiatansandi: TStringField;
    MyQRefJenis_Kegiatannama: TStringField;
...
var
  fr_EntryFormE1100: Tfr_EntryFormE1100;
...
function Tfr_EntryFormE1100.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE1100.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE1100.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE1100.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE1100.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE1100.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE1100.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE1100.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
