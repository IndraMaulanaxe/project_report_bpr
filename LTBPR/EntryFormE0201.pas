...
var
  fr_EntryFormE0201: Tfr_EntryFormE0201;
...
function Tfr_EntryFormE0201.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0201.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0201.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0201.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0201.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0201.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0201.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0201.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
