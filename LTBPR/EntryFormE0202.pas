...
type
  Tfr_EntryFormE0202 = class(Tfr_new_template)
...
var
  fr_EntryFormE0202: Tfr_EntryFormE0202;
...
function Tfr_EntryFormE0202.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0202.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0202.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0202.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0202.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0202.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0202.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0202.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
