...
) ENGINE=InnoDB AUTO_INCREMENT=77222 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(77218,'LOGIN_PROFIL_RISIKO_INDRA_MAULANA','Y','855','2026-02-24 12:16:59','IT','11.11.11.42','DH-IT INDRA',NULL),
...
/*Table structure for table `ltbpr_header_arsip` */

DROP TABLE IF EXISTS `ltbpr_header_arsip`;

CREATE TABLE `ltbpr_header_arsip` (
  `flag_header` varchar(3) NOT NULL DEFAULT 'H01' COMMENT 'Diisi dengan "H01"',
  `kode_sektor` varchar(6) NOT NULL DEFAULT '010201' COMMENT 'Diisi dengan "010201" (BPR Konvensional)',
  `sandi_bpr` varchar(6) NOT NULL COMMENT 'Diisi dengan Sandi BPR',
  `periode_data` date NOT NULL COMMENT 'Format: YYYY-MM-DD dan menggunakan tanggal',
...
/*Data for the table `ltbpr_header_arsip` */

/*Table structure for table `ltbpr_ref_kode_form` */

DROP TABLE IF EXISTS `ltbpr_ref_kode_form`;

CREATE TABLE `ltbpr_ref_kode_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `ltbpr_ref_kode_form` */
...
/*Table structure for table `ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain_arsip` */

DROP TABLE IF EXISTS `ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain_arsip`;

CREATE TABLE `ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain_arsip` (
  `flag_detail` varchar(3) NOT NULL COMMENT 'Diisi dengan "D01" - huruf dan angka',
  `kode_komponen` varchar(12) NOT NULL COMMENT 'Diisi dengan "02201000000" - angka',
  `nik` varchar(25) NOT NULL COMMENT 'Tidak muncul di output APOLO - angka',
  `nama` varchar(50) NOT NULL COMMENT 'Huruf, angka, spasi, karakter selain enter',
...
/*Data for the table `ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain_arsip` */
...
/*Table structure for table `ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham_arsip` */

DROP TABLE IF EXISTS `ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham_arsip`;

CREATE TABLE `ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham_arsip` (
  `flag_detail` varchar(3) NOT NULL COMMENT 'Diisi dengan "D01" - huruf dan angka',
  `kode_komponen` varchar(12) NOT NULL COMMENT 'Diisi dengan "031010000000" - angka',
  `nik` varchar(25) NOT NULL COMMENT 'Bersifat unik - angka',
  `hubungan_keuangan_i_anggota` varchar(2000) NOT NULL COMMENT 'Diisi dengan format nama - hubungan keuangan dan dapat diisi lebih dari satu - huruf, angka, spasi, karakter',
...
/*Data for the table `ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham_arsip` */
...
/*Table structure for table `ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham_arsip` */

DROP TABLE IF EXISTS `ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham_arsip`;

CREATE TABLE `ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham_arsip` (
  `flag_detail` varchar(3) NOT NULL COMMENT 'Diisi dengan "D01" - huruf dan angka',
  `kode_komponen` varchar(12) NOT NULL COMMENT 'Diisi dengan "032010000000" - angka',
  `nik` varchar(25) NOT NULL COMMENT 'Bersifat unik - angka',
  `hubungan_keluarga_i_anggota_direksi` varchar(2000) NOT NULL COMMENT 'Diisi dengan format nama - hubungan Keluarga dan dapat diisi lebih dari satu hubungan yang dipisahkan dgn tanda koma atau diisi "tidak ada" - huruf, angka, spasi, karakter kecuali enter dan |',
...
/*Data for the table `ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham_arsip` */
...
insert  into `ref_kode_form`(`id`,`kode_form`,`nama_form`,`nama_table`) values 
(28,'a0301','ltbprk_a0301_riwayat_pendirian_bpr','ltbprk_a0301_riwayat_pendirian_bpr'),
(29,'a0304','ltbprk_a0304_penjelasan_npl','ltbprk_a0304_penjelasan_npl'),
(30,'a0502','ltbprk_a0502_bidang_usaha','ltbprk_a0502_bidang_usaha'),
(31,'a0506','ltbprk_a0506_kerja_sama_lembaga','ltbprk_a0506_kerja_sama_lembaga'),
(32,'a05072','ltbprk_a05072_kegiatan_pengembangan','ltbprk_a05072_kegiatan_pengembangan'),
(33,'e0100','ltbprk_e0100_transparansi_tata_kelola','ltbprk_e0100_transparansi_tata_kelola'),
(34,'e0201','ltbprk_e0201_tugas_tanggung_jawab_direksi','ltbprk_e0201_tugas_tanggung_jawab_direksi'),
(35,'e0202','ltbprk_e0202_tugas_tanggung_jawab_komisaris','ltbprk_e0202_tugas_tanggung_jawab_komisaris'),
(36,'e0203','ltbprk_e0203_tugas_tanggung_jawab_komite','ltbprk_e0203_tugas_tanggung_jawab_komite'),
(37,'e0204','ltbprk_e0204_struktur_independensi_anggota_komite','ltbprk_e0204_struktur_independensi_anggota_komite'),
(38,'e0302','ltbprk_e0302_kepemilikan_saham_kelompok_usaha','ltbprk_e0302_kepemilikan_saham_kelompok_usaha'),
(39,'e0303','ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain','ltbprk_e0303_kepemilikan_saham_pada_perusahaan_lain'),
(40,'e0401','ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham','ltbprk_e0401_hubungan_keuangan_direksi_pemegang_saham'),
(41,'e0402','ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham','ltbprk_e0402_hubungan_keluarga_direksi_pemegang_saham'),
(42,'e0500','ltbprk_e0500_kebijakan_berdasarkan_rups','ltbprk_e0500_kebijakan_berdasarkan_rups'),
(43,'e0600','ltbprk_e0600_rasio_gaji_tinggi_rendah','ltbprk_e0600_rasio_gaji_tinggi_rendah'),
(44,'e0701','ltbprk_e0701_pelaksanaan_rapat_dalam_setahun','ltbprk_e0701_pelaksanaan_rapat_dalam_setahun'),
(45,'e0702','ltbprk_e0702_kehadiran_anggota_komisaris','ltbprk_e0702_kehadiran_anggota_komisaris'),
(46,'e0800','ltbprk_e0800_penyimpangan_internal','ltbprk_e0800_penyimpangan_internal'),
(47,'e0900','ltbprk_e0900_permasalahan_hukum','ltbprk_e0900_permasalahan_hukum'),
(48,'e1000','ltbprk_e1000_transaksi_benturan_kepentingan','ltbprk_e1000_transaksi_benturan_kepentingan'),
(49,'e1100','ltbprk_e1100_pemberian_dana_sosial_politik','ltbprk_e1100_pemberian_dana_sosial_politik');
...
('TGL_LTBPR','2018-12-31'),
('TGL_PROFIL_RISIKO','2018-12-31');
...
CREATE TABLE `user_log` (
  ...
  KEY `kd_menu` (`kd_menu`),
  KEY `waktu` (`waktu`)
) ENGINE=InnoDB AUTO_INCREMENT=231 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='log user yang mengakses program';
