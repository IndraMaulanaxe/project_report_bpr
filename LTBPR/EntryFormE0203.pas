...
type
  Tfr_EntryFormE0203 = class(Tfr_new_template)
...
var
  fr_EntryFormE0203: Tfr_EntryFormE0203;
...
function Tfr_EntryFormE0203.Cek_Validasi(Sender: TObject): Boolean;
var
  jml: Integer;
  cPesan, cHint: string;
begin
...
procedure Tfr_EntryFormE0203.btlb_SaveClick(Sender: TObject);
begin
  inherited;
...
procedure Tfr_EntryFormE0203.FormActivate(Sender: TObject);
var
  jml: Integer;
begin
...
procedure Tfr_EntryFormE0203.FormClose(Sender: TObject;
...
procedure Tfr_EntryFormE0203.FormCloseQuery(Sender: TObject;
...
procedure Tfr_EntryFormE0203.FormCreate(Sender: TObject);
var
  jml, jml2: Integer;
...
procedure Tfr_EntryFormE0203.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    begin
      Key := #0;
...
procedure Tfr_EntryFormE0203.MemKeteranganPropertiesChange(
  Sender: TObject);
begin
  inherited;
  Tag := 1;
